import 'package:erigo/users/controllers/order_now_controller.dart';
import 'package:erigo/users/order/order_confirmation.dart';
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: FadeInImage(
                  ...
                  width: 130,
                  fit: BoxFit.cover,
                  placeholder: const AssetImage("images/payment.png"),
                  image: NetworkImage(
